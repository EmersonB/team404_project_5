...
class SensorWeather():
        ...
        def json_now(self):
                self.update_all()
                dict = {"ID": self.device_id, "Description": self.device_description, "Fixed": self.device_fixed, "Latitude": self.device_lat, "Longitude": self.device_lon, "Time": self.device_last_time, "Info": {"Temperature": self.device_last_temp, "Humidity": self.device_last_humidity, "Pressure": self.device_last_mag}}
                return dict
